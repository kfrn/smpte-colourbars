...
function drawFFmpegTestsrc(x, y, width, height) {
  ...
  // Black background
  g.append('rect').attr('class', 'black-count').attr('x', width * 0.8).attr('y', height * 0.4).attr('width', barWidth * 0.7).attr('height', height * 0.2).attr('fill', 'black');

  // Top of '1'
  g.append('rect').attr('class', 'white-count').attr('x', width * 0.8 + barWidth * 0.6).attr('y', height * 0.4 + height * 0.02).attr('width', barWidth * 0.1).attr('height', height * 0.07).attr('fill', 'white');

  // Bottom of '1'
  g.append('rect').attr('class', 'white-count').attr('x', width * 0.8 + barWidth * 0.6).attr('y', height * 0.5 + height * 0.01).attr('width', barWidth * 0.1).attr('height', height * 0.07).attr('fill', 'white');
}
...
function drawHDColourBars(x, y, width, height) {
    ...
    g.append('rect').attr('x', x).attr('y', y + height * 0.6).attr('width', cornerBlock).attr('height', height * 0.1).attr('fill', 'cyan');

    // Top ribbon, second block
    g.append('rect').attr('x', x + cornerBlock).attr('y', y + height * 0.6).attr('width', barWidth).attr('height', height * 0.1).attr('fill', smpteBlue);

    // Top ribbon, third block (long grey)
    g.append('rect').attr('x', x + cornerBlock + barWidth).attr('y', y + height * 0.6).attr('width', barWidth * 6).attr('height', height * 0.1).attr('fill', 'lightgrey');

    // Top ribbon, last block
    g.append('rect').attr('x', x + width * 0.875).attr('y', y + height * 0.6).attr('width', cornerBlock).attr('height', height * 0.1).attr('fill', 'blue');

    // Bottom ribbon, first block
    g.append('rect').attr('x', x).attr('y', y + height * 0.7).attr('width', cornerBlock).attr('height', height * 0.1).attr('fill', 'yellow');

    // Bottom ribbon, second block
    g.append('rect').attr('x', x + cornerBlock).attr('y', y + height * 0.7).attr('width', barWidth).attr('height', height * 0.1).attr('fill', smptePurple);

    // Bottom ribbon, third block (gradient)

    var gradient = g.append('linearGradient').attr('id', 'hdGradient').attr('x1', '0').attr('x2', '1').attr('y1', '0').attr('y2', '0');
    ...
    g.append('rect').attr('x', x + cornerBlock + barWidth).attr('y', y + height * 0.7).attr('width', barWidth * 6).attr('height', height * 0.1).attr('fill', 'url(#hdGradient)');

    // Bottom ribbon, last block
    g.append('rect').attr('x', x + width * 0.875).attr('y', y + height * 0.7).attr('width', cornerBlock).attr('height', height * 0.1).attr('fill', 'red');

    /* BOTTOM SECTION - 20% of HEIGHT. L-R */

    // First black patch
    g.append('rect').attr('x', x + cornerBlock).attr('y', y + height * 0.8).attr('width', barWidth * 1.5).attr('height', height * 0.2).attr('fill', semiBlack);

    // White patch
    g.append('rect').attr('x', x + cornerBlock + barWidth * 1.5).attr('y', y + height * 0.8).attr('width', barWidth * 2).attr('height', height * 0.2).attr('fill', 'white');
    ...
    g.append('rect').attr('x', x + width * 0.125 + barWidth * 6).attr('y', y + height * 0.8).attr('width', barWidth).attr('height', height * 0.2).attr('fill', semiBlack);
}
